...
addEventListener("resize", () => {
  addEventListener("mousemove", (e) => {
    if (mq1.matches) {
      ...
      el13.style.transform = `translate(${x / 150}px, ${
        y / 150
      }px) scale(0.65)`;
      el14.style.transform = `translate(${x / 100}px, ${
        y / -100
      }px) scale(0.65)`;
      el15.style.transform = `translate(${x / -100}px, ${
        y / 30
      }px) scale(0.65)`;
      el16.style.transform = `translate(${x / 120}px, ${
        y / 100
      }px) scale(0.65)`;
      el17.style.transform = `translate(${x / -150}px, ${
        y / 200
      }px) scale(0.65)`;
      el18.style.transform = `translate(${x / -80}px, ${
        y / 120
      }px) scale(0.65)`;
    } else {
      let x = e.clientX;
